...
Procedure screenshot provenance — current private Git history:

- Original captures enter private Git history in commit `79797662bc7791dbb82d14478dfef7a0888d7819`.
- Copies with the stable evidence filenames enter private Git history in commit `47963252601801e602d37e079268d1a75074c7c2`.
- These commits establish the currently verifiable private Git traceability. Git history alone does not establish the exact working-tree or tracking state at the moment of capture/export.
...
| `evidence/procedure/C1-codex-blind-implementation-crop.png` | `.../screenshots/original/C1-codex-blind-implementation-original.png` | private procedure capture history above | `ff3ab2b2556ce9f8b5f1968ae8f57fa97878912aecca7f5a611acd6cbfec1b85` | `1091661a28ebd5edc710861cd897b4102e943c81c0b0906f679c04318080c169` | PUBLIC_REQUIRED | Crop only; removes account/sidebar context. |
| `evidence/procedure/C2-codex-later-reveal-crop.png` | `.../screenshots/original/C2-codex-later-reveal-original.png` | private procedure capture history above | `6ab20845e8f2d36d0795c903f5ee3b421de917abab00c902c88b1c368050baaf` | `0db0dd72e1674e5115c89f34b0ccc64317aa1fc57f244b335d1dd827ba67a0ae` | PUBLIC_SUPPORTING | Crop only; later reveal. |
| `evidence/procedure/C3-claude-control-pass-crop.png` | `.../screenshots/original/C3-claude-control-pass-original.png` | private procedure capture history above | `e8fc529d7fc6fdaf50e12066b20497ff323ec0755717620fb2ecdb33b7a824d4` | `e1b3ada4d51db6c7602f3c749c79d2f661f092b56567ba0eb557a0395e697778` | PUBLIC_SUPPORTING | Crop only; clean/control PASS. |
| `evidence/procedure/C4a-claude-adversarial-submit-crop.png` | `.../screenshots/original/C4a-claude-adversarial-submit-original.png` | private procedure capture history above | `43f54ca64231eb28464093c2780b554a67767f4e531e7b177cd865be3c404d72` | `805d0a1948258bdb532965c468f2079a53a3482c5f1950c72ca6b9127b71bedf` | PUBLIC_SUPPORTING | Crop only; expected failing invariant is not specified. |
| `evidence/procedure/C4b-claude-adversarial-fail-crop.png` | `.../screenshots/original/C4b-claude-adversarial-fail-original.png` | private procedure capture history above | `5fe82098d5cb7d59362af2d701e00b869413fab8a920c10b10d00bede1d53da6` | `592ed1456a43b01b353bf91d4b90f86c3a2d58e33d8c7529a77aa2b4776588b3` | PUBLIC_REQUIRED | Crop only; main FAIL result. |
| `evidence/secondary/invariant-kernel-pre-repair-evaluation.json` | `.../PRE_REPAIR_LIVE_EVALUATION_20260911.json` | secondary proof branch/tag above | `146b41e6e3468c593a49ca660a5fedf5f6252702ab3e514d4509938480979c11` | `146b41e6e3468c593a49ca660a5fedf5f6252702ab3e514d4509938480979c11` | PUBLIC_SUPPORTING | JSON semantic content is identical. The private preservation and public Git blobs are LF and byte-identical at the recorded hash; the Windows CRLF working-tree SHA-256 is `7d25bd76ceeb2179cd8cee4e9f881f4ecf1193180f8dd6a9b4b630efaa065797`. |
